...
int main(int argc, char **argv)
{
    ...
    TESTCASE("sin(pi/6)", 0.5, &ret);
    TESTCASE("cos(pi/3)", 0.5, &ret);
    TESTCASE("tan(pi/4)", 1, &ret);
    ...
    TESTCASE("sin(pi/6) * 2", 1, &ret);
    TESTCASE("cos(pi/3) + exp(1)", 3.21827, &ret);
    TESTCASE("sqrt(25) / 5", 1, &ret);
    TESTCASE("log10(1000) - log2(8)", 0, &ret);
    TESTCASE("ln(10) / 2", 1.15129, &ret);
    TESTCASE("sin(pi/3) + cos(pi/6)", 1.73205, &ret);
